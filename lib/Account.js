...
class Account {
  ...
  getEndpoints(callback) {
    ...
    Logger.debug(`Requesting endpoint URL 'https://cdws.us-east-1.amazonaws.com/drive/v1/account/endpoint'.`);
  ...
  getInfo(callback) {
    ...
    Logger.debug(`Requesting endpoint URL '${this.metadataUrl}account/info'.`);
  ...
  getQuota(callback) {
    ...
    Logger.debug(`Requesting endpoint URL '${this.metadataUrl}account/quota'.`);
  ...
  getUsage(callback) {
    ...
    Logger.debug(`Requesting endpoint URL '${this.metadataUrl}account/usage'.`);
  ...
  renewAuthorization(callback) {
    ...
    if (!this.clientId || !this.clientSecret) {
      Logger.debug(`Requesting endpoint URL 'https://data-mind-687.appspot.com/clouddrive?refresh_token=${this.token.refresh_token}'.`);
      ...
      Logger.debug(`Requesting endpoint URL 'https://api.amazon.com/auth/o2/token'.`);
  ...
  getChanges(params, callback) {
    ...
    Logger.debug(`Requesting endpoint URL '${this.metadataUrl}changes'.`);
